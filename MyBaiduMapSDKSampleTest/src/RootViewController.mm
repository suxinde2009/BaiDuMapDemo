...
- (void)viewDidLoad
{
    ...
    MultiMapViewDemo *multiMapViewDemo = [[[MultiMapViewDemo alloc] init] autorelease];
	multiMapViewDemo.title = @"多地图使用功能";
    ...
    HeatMapDemo *heatMapDemo = [[[HeatMapDemo alloc] init] autorelease];
	heatMapDemo.title = @"热力图功能";
    ...
    [array addObject:multiMapViewDemo];
    ...
    UILabel * welcomLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 20, 320, 40)];
    welcomLabel.text = @"欢迎使用百度地图iOS SDK";
    ...
    [welcomLabel addSubview:lineView];
    

    self.tableView.tableHeaderView = welcomLabel;
}
